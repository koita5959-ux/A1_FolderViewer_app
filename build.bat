...
cd %~dp0
powershell -NoProfile -Command "Compress-Archive -Path 'installer\FolderViewer_Setup_v1.01.exe','windowsdesktop-runtime-8.0.24-win-x64.exe','ご利用ガイド.txt' -DestinationPath 'FolderViewer1.01_installer.zip' -Force"
if errorlevel 1 (
    echo.
